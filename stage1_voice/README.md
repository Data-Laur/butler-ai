...
Prints the resulting Task as pretty JSON — Bidipta: use `--text` to feed stage 3 without audio.
...
`configs/default.yaml` → `scene:` (Azeem may update `scene.objects` as the MuJoCo
